...
const CartModal = ({ handleClose }) => {
	...
	return (
		<motion.div
			...
			<div className="bg-primary text-bkgrd flex justify-around items-center pb-6">
				<p className="relative inline-flex items-center justify-start pl-4 pr-12 overflow-hidden font-semibold mt-6 text-2xl">
					{username}'s Cart
				</p>
